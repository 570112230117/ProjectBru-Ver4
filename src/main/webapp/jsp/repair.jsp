                                ...
                                <div class="col-md-6">
                                    <div class="box box-primary">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="repairDate" class="form-control" disabled value="<%Date dNow = new Date(); SimpleDateFormat ft = new SimpleDateFormat(" dd-MM-yyyy HH:mm:ss ");out.print(ft.format(dNow));%>" name="repairDate">
                                        </div>
                                        <div class="form-group">
